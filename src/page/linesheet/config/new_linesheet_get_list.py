...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item" style="font-size:13px" onclick="open_xlsm(&#39;'''+excel_file+'''&#39;)"><ion-icon name="open-outline"></ion-icon>Open Excel</a></li>
    <li><a class="dropdown-item" style="font-size:13px" onclick="read_json_xlsm(&#39;'''+folder_name+'''/'''+excel_file+'''&#39;)"><ion-icon name="color-wand-outline"></ion-icon>Enrichments</a></li>
    <hr class="mt-1 mb-1">
    <li><a class="dropdown-item" style="font-size:13px" onclick="read_json_xlsm_convert(&#39;'''+folder_name+'''/'''+excel_file+'''&#39;)"><ion-icon name="rocket-outline"></ion-icon>Convert to PIM</a></li>
  </ul>
</div>
