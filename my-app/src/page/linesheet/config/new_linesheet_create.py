...
def generate_form(brand,template,sku,launch_date,stock_source,sale_channel,production_type,contact_person):
    ...
    # attribute = attribute[attribute['sale_channel'].isin(selected_sale_channel_list)]
    ...
    # query = "SELECT label_th, family  FROM im_form.categories_setting where deepen_level = true"
...
# #### call function Add a column
    ...
    add_column(8,'DA9694','B41010',fill_type,False,False,comment,'script',False)
